...
namespace Microsoft.AzCopy
{
    ...
    internal class TransferStatusJsonConverter : JsonConverter<TransferStatus>
    {
        ...
        {
            return (TransferStatus) Enum.Parse(typeof(TransferStatus), reader.GetString() ?? throw new Exception($"Null string in transfer status"));
        }
    ...
    internal class PerfConstraintJsonConverter : JsonConverter<PerfConstraint>
    {
        ...
        {
            return (PerfConstraint) Enum.Parse(typeof(PerfConstraint), reader.GetString() ?? throw new Exception($"Null string in transfer status"));
        }
