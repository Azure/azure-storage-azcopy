...
namespace Microsoft.AzCopy
{
    ...
    public struct Env
    {
        ...
        internal Dictionary<string, string> PrepareEnvironment()
        {
            ...
            {
                if (entry.Key.GetType() != typeof(string) || entry.Value.GetType() != typeof(string))
                    continue;

                flags.Add((string) entry.Key, (string) entry.Value);
            }
    ...
    public class CopyFlags : Flags
    {
        ...
        [DictionaryFlag("blob-tags")] public Dictionary<string, string> BlobTags;
        ...
        [ListFlag("exclude-blob-type")] public BlobType[] ExcludeBlobTypes;
        ...
        [DictionaryFlag("metadata")] public Dictionary<string, string> Metadata;
