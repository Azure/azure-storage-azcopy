...
func (s FileSystemURL) GetAccessControl(ctx context.Context) (BlobFSPermissions, error) {
	return s.NewRootDirectoryURL().GetAccessControl(ctx)
}

func (s FileSystemURL) SetAccessControl(ctx context.Context, permissions BlobFSPermissions) (*PathUpdateResponse, error) {
