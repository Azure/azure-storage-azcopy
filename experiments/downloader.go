...
func DownloadBlobToFile(blobUrlString, destinationPath string) int64{
	...
	createAndInitializeFile(destinationPath, blobSize) // TODO create and map in one call
...
// opens/creates the file and truncates it to the desired size
func createAndInitializeFile(destinationPath string, fileSize int64)  {
