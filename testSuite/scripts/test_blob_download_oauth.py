...
def test_recursive_download_blob_oauth():
    ...
    result = util.Command("copy").add_arguments(dir1_path).add_arguments(dest).add_flags("Logging",
                                                                                                            "info").add_flags(
    ...
    result = util.Command("copy").add_arguments(src_download).add_arguments(util.test_directory_path).add_flags(
