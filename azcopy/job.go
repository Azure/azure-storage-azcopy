...
type JobLifecycleManager struct {
	...
	lastError       string
	handler         *common.JobOutputHandler
}
...
func NewJobLifecycleManager(handler *common.JobOutputHandler) *JobLifecycleManager {
...
func (j *JobLifecycleManager) cancelJob(jobID common.JobID) error {
	...
	resp := jobsAdmin.CancelPauseJobOrder(jobID, common.EJobStatus.Cancelling(), j.OnError)
