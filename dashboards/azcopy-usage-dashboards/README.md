...
The Data, Customer Drilldown, Recurring Trends, and No Observed Success dashboards were superseded on September 7, 2026 by the saved-query-based [AzCopy dashboard suite](../AzCopyQueries/SUITE.md). Use that suite's generators and publishing scripts for those four dashboards. This directory remains the legacy raw-query implementation; its Observed Funnel dashboard was not replaced.
