...
const rootCmdLongDescription = "AzCopy " + common.AzcopyVersion +
	`
Project URL: github.com/aymanjarrousms/azure-storage-azcopy

AzCopy is a command line tool that moves data into and out of Azure Storage.
To report issues or to learn more about the tool, go to github.com/aymanjarrousms/azure-storage-azcopy
