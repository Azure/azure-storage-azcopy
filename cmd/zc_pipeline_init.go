...
func InitPipeline(ctx context.Context, location common.Location, credential common.CredentialInfo, logLevel pipeline.LogLevel) (p pipeline.Pipeline, sourceBlobToken azblob.Credential, err error) {
	switch location {
	...
	case common.ELocation.Blob():
		p, sourceBlobToken, err = createBlobPipeline(ctx, credential, logLevel)
