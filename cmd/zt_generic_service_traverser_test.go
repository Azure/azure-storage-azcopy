...
func (s *genericTraverserSuite) TestBlobFSServiceTraverserWithManyObjects(c *chk.C) {
	...
	localTraverser := newLocalTraverser(context.TODO(), dstDirName, true, true, common.ESyncHashType.None(), common.ESyncMissingHashPolicy.Generate(), func(common.EntityType) {}, nil)
