...
### Dependency updates
1. cloud.google.com/go/storage v1.45.0 -> 1.50.0
...
2. Fixed a regression where cancellation was not working via std-in ([#3373](https://github.com/Azure/azure-storage-azcopy/issues/3373))
3. Fixed a regression where we hit seg faults from logging to a nil logger in the process checker. ([#3384](https://github.com/Azure/azure-storage-azcopy/pull/3384))
