...
func (s *S2SSuite) Scenario_PageBlobToPageBlob(svm *ScenarioVariationManager) {
...
func (s *S2SSuite) Scenario_AppendBlobToAppendBlob(svm *ScenarioVariationManager) {
	fileName := "test_copy.txt"
...
func (s *S2SSuite) Scenario_BlockBlobBlockBlob(svm *ScenarioVariationManager) {
	fileName := "test_copy.txt"
	size := ResolveVariation(svm, []int64{0, 1, 8*common.MegaByte - 1, 8 * common.MegaByte, 8*common.MegaByte + 1})
	body := NewRandomObjectContentContainer(svm, size)
...
func (s *S2SSuite) Scenario_BlockBlobBlockBlobNoPreserveTier(svm *ScenarioVariationManager) {
	fileName := "test_copy.txt"
...
func (s *S2SSuite) Scenario_BlobDestinationPropertyMetadata(svm *ScenarioVariationManager) {
