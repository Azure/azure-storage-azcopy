...
type ResourceDefinition interface {
	...
	DefinitionTarget() traverser.LocationLevel
	...
	ApplyDefinition(a Asserter, target ResourceManager, applicationFunctions map[traverser.LocationLevel]func(Asserter, ResourceManager, ResourceDefinition))
...
func (r ResourceDefinitionService) ApplyDefinition(a Asserter, target ResourceManager, applicationFunctions map[traverser.LocationLevel]func(Asserter, ResourceManager, ResourceDefinition)) {
	a.HelperMarker().Helper()
...
func (r ResourceDefinitionService) DefinitionTarget() traverser.LocationLevel {
...
func (r ResourceDefinitionContainer) ApplyDefinition(a Asserter, target ResourceManager, applicationFunctions map[traverser.LocationLevel]func(Asserter, ResourceManager, ResourceDefinition)) {
	a.HelperMarker().Helper()
	a.AssertNow("target must match level", Equal{}, target.Level(), r.DefinitionTarget())
...
func (r ResourceDefinitionContainer) DefinitionTarget() traverser.LocationLevel {
...
func (r ResourceDefinitionObject) ApplyDefinition(a Asserter, target ResourceManager, applicationFunctions map[traverser.LocationLevel]func(Asserter, ResourceManager, ResourceDefinition)) {
	a.HelperMarker().Helper()
	a.AssertNow("target must match level", Equal{}, target.Level(), r.DefinitionTarget())
...
func (r ResourceDefinitionObject) DefinitionTarget() traverser.LocationLevel {
