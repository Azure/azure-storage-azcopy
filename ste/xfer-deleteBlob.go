...
func doDeleteBlob(jptm IJobPartTransferMgr, p pipeline.Pipeline) {
	...
	_, err := srcBlobURL.Delete(jptm.Context(), jptm.DeleteSnapshotsOption().ToDeleteSnapshotsOptionType(), azblob.BlobAccessConditions{}, jptm.PermanentDeleteOption().ToPermanentDeleteOptionType())
	if err != nil {
