...
type IJobPartMgr interface {
	...
	ScheduleTransfers(jobCtx context.Context, srcCredential azblob.Credential)
...
func (jpm *jobPartMgr) ScheduleTransfers(jobCtx context.Context, srcCredential azblob.Credential) {
	...
	jpm.sourceCredential = srcCredential
