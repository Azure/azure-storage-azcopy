...
func ExecuteNewCopyJobPartOrder(payload common.CopyJobPartOrder){
	/*
...
func validateAndRouteHttpPostRequest(payload common.CopyJobPartOrder) (bool){
	switch {
...
func initializedChannels(){
	...
	JobPartOrderChannel := make(chan common.CopyJobPartOrder, 500)
